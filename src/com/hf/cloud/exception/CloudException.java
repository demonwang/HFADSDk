package com.hf.cloud.exception;
...
public class CloudException extends Exception{
	...
	//common 
    public static final int ERROR_CODE_COMMOM_UNKNOWN_MESSAGE 				= -11; //δ֪
	public static final int ERROR_CODE_COMMOM_PRIVILEGE_ILLEGAL             = -12; //Ȩ�޷Ƿ�
    ...
    public static final int ERROR_CODE_COMMOM_MESSAGE_PATTERN_ILLEGAL       = -16;  //json ��ʽ���� 
    public static final int ERROR_CODE_COMMOM_MESSAGE_INPUT_ILLEGAL         = -17; //json ����
	...
	public CloudException(int errorCode) {
	    super();
	...
	public CloudException(int errorCode, String message, Throwable cause) {
	    super(message, cause);
	    this.errorCode = errorCode;
    }
	...
	public CloudException(int errorCode,Throwable cause) {
	    super(cause);
	    this.errorCode = errorCode;
    }
